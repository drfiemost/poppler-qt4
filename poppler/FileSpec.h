...
public:
  ...
  GooString *modDate() const { return m_modDate; }
  GooString *createDate() const { return m_createDate; }
  GooString *checksum() const { return m_checksum; }
  GooString *mimeType() const { return m_mimetype; }
